...
@Component({
  ...
  styleUrl: './sala-de-prensa.component.css',
})
export class SalaDePrensaComponent {
  listCategories: any = [];
  files_date: any;
  submitted = false;
  data: any;
  ...
  onEdit(category: Sala) {
    console.log(category);
    this.dataService.selectCategory = Object.assign({}, category);
    this.router.navigate(['/admin/publicaciones/sala-de-prensa/edit'], {
      queryParams: { categoryId: category.id_sala },
    });
  }
