...
import { Industrias } from 'src/app/models/industrias.model';
import { IndustriaService } from 'src/app/services/industria.service';
...
@Component({
  ...
  templateUrl: './edit-industria.component.html',
  styleUrl: './edit-industria.component.css',
})
export class EditIndustriaComponent {
  listCategories: any = [];
  files_date: any;
  submitted = false;
  data: any;
  ...
  valor_id_industria: any;
  categoriaIndustriaId: any = 1;
  ...
  constructor(
    ...
    private dataService: IndustriaService,
  ...
  ngOnInit(): void {
    ...
    this.route.queryParams.subscribe((params) => {
      ...
      this.valor_id_industria = categoryId;
    });
  }
  ...
  onSubmit() {
    ...
    formData.append('id_industria', this.valor_id_industria);
    ...
    this.dataService.updateData(formData).subscribe((res) => {
      ...
      this.alerta();
      this.router.navigate(['/admin/industria']);
    });
  }
