...
@Component({
  ...
  templateUrl: './slider-miembro.component.html',
  styleUrl: './slider-miembro.component.css',
})
export class SliderMiembroComponent {
  listCategories: any = [];
  files_date: any;
  submitted = false;
  data: any;
  ...
  onEdit(category: SliderMiembro) {
    console.log(category);
    this.dataService.selectCategory = Object.assign({}, category);
    this.router.navigate(['/admin/slider/miembro/edit'], {
      queryParams: { categoryId: category.id_slider_miembro },
    });
  }
