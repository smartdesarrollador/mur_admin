...
@Component({
  selector: 'app-create-slider-miembro',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './create-slider-miembro.component.html',
  styleUrl: './create-slider-miembro.component.css',
})
export class CreateSliderMiembroComponent {
  listCategories: any = [];
  files_date: any;
  submitted = false;
  data: any;
