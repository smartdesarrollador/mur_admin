...
import { SliderMiembro } from 'src/app/models/slider_miembro.model';
...
@Component({
  selector: 'app-edit-slider-miembro',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './edit-slider-miembro.component.html',
  styleUrl: './edit-slider-miembro.component.css',
})
export class EditSliderMiembroComponent {
  listCategories: any = [];
  files_date: any;
  submitted = false;
  data: any;
  ...
  valor_id_slider_miembro: any;
  categoriaSliderMiembroId: any = 1;
  ...
  ngOnInit(): void {
    ...
    this.route.queryParams.subscribe((params) => {
      ...
      this.valor_id_slider_miembro = categoryId;
    });
  }
  ...
  onSubmit() {
    ...
    this.dataService.updateData(formData).subscribe((res) => {
      ...
      this.alerta();
      this.router.navigate(['/admin/slider/miembro']);
    });
  }
