...
@Component({
  selector: 'app-edit-banner-equipo',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './edit-banner-equipo.component.html',
  styleUrl: './edit-banner-equipo.component.css',
})
export class EditBannerEquipoComponent implements OnInit {
  listCategories: any = [];
  files_date: any;
  submitted = false;
  data: any;
  ...
  valor_id_banner_equipo: any;
  post = new BannerEquipo();
  constructor(
    private formBuilder: FormBuilder,
    private dataService: BannerEquipoService,
  ...
  ngOnInit(): void {
    ...
    this.route.queryParams.subscribe((params) => {
      ...
      this.valor_id_banner_equipo = categoryId;
    });
  }
  ...
  onSubmit() {
    ...
    formData.append('id_banner_equipo', this.valor_id_banner_equipo);

    this.dataService.updateData(formData).subscribe((res) => {
      this.data = res;
      console.log(this.data);
      this.alerta();
      this.router.navigate(['/admin/banner/equipo']);
    });
  }
