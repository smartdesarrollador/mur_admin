...
import { SliderReconocimiento } from 'src/app/models/slider_reconocimiento.model';
...
@Component({
  selector: 'app-edit-slider-reconocimiento',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './edit-slider-reconocimiento.component.html',
  styleUrl: './edit-slider-reconocimiento.component.css',
})
export class EditSliderReconocimientoComponent {
  listCategories: any = [];
  files_date: any;
  submitted = false;
  data: any;
  ...
  valor_id_slider_reconocimiento: any;
  categoriaSliderReconocimientoId: any = 1;
  ...
  ngOnInit(): void {
    ...
    this.route.queryParams.subscribe((params) => {
      ...
      this.valor_id_slider_reconocimiento = categoryId;
    });
  }
  ...
  onSubmit() {
    ...
    this.dataService.updateData(formData).subscribe((res) => {
      ...
      this.alerta();
      this.router.navigate(['/admin/slider/reconocimiento']);
    });
  }
