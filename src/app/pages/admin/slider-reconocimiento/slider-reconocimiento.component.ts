...
@Component({
  selector: 'app-slider-reconocimiento',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './slider-reconocimiento.component.html',
  styleUrl: './slider-reconocimiento.component.css',
})
export class SliderReconocimientoComponent {
  listCategories: any = [];
  files_date: any;
  submitted = false;
  data: any;
  ...
  onEdit(category: SliderReconocimiento) {
    console.log(category);
    this.dataService.selectCategory = Object.assign({}, category);
    this.router.navigate(['/admin/slider/reconocimiento/edit'], {
      queryParams: { categoryId: category.id_slider_reconocimiento },
    });
  }
