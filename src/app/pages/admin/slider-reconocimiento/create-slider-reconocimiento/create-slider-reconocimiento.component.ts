...
@Component({
  selector: 'app-create-slider-reconocimiento',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './create-slider-reconocimiento.component.html',
  styleUrl: './create-slider-reconocimiento.component.css',
})
export class CreateSliderReconocimientoComponent {
  listCategories: any = [];
  files_date: any;
  submitted = false;
  data: any;
