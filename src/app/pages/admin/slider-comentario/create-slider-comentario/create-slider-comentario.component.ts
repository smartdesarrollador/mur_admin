...
@Component({
  selector: 'app-create-slider-comentario',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './create-slider-comentario.component.html',
  styleUrl: './create-slider-comentario.component.css',
})
export class CreateSliderComentarioComponent {
  listCategories: any = [];
  files_date: any;
  submitted = false;
  data: any;
