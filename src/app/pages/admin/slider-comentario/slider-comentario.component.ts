...
@Component({
  selector: 'app-slider-comentario',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './slider-comentario.component.html',
  styleUrl: './slider-comentario.component.css',
})
export class SliderComentarioComponent {
  listCategories: any = [];
  files_date: any;
  submitted = false;
  data: any;
  ...
  onEdit(category: SliderComentario) {
    console.log(category);
    this.dataService.selectCategory = Object.assign({}, category);
    this.router.navigate(['/admin/slider/comentario/edit'], {
      queryParams: { categoryId: category.id_slider_comentario },
    });
  }
