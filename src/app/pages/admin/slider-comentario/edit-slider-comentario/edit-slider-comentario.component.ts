...
import { SliderComentario } from 'src/app/models/slider_comentario.model';
...
@Component({
  selector: 'app-edit-slider-comentario',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './edit-slider-comentario.component.html',
  styleUrl: './edit-slider-comentario.component.css',
})
export class EditSliderComentarioComponent {
  listCategories: any = [];
  files_date: any;
  submitted = false;
  data: any;
  ...
  valor_id_slider_comentario: any;
  categoriaSliderComentarioId: any = 1;
  ...
  ngOnInit(): void {
    ...
    this.route.queryParams.subscribe((params) => {
      ...
      this.valor_id_slider_comentario = categoryId;
    });
  }
  ...
  onSubmit() {
    ...
    this.dataService.updateData(formData).subscribe((res) => {
      ...
      this.alerta();
      this.router.navigate(['/admin/slider/comentario']);
    });
  }
