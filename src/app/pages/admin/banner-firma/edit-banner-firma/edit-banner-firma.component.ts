...
@Component({
  selector: 'app-edit-banner-firma',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './edit-banner-firma.component.html',
  styleUrl: './edit-banner-firma.component.css',
})
export class EditBannerFirmaComponent implements OnInit {
  listCategories: any = [];
  files_date: any;
  submitted = false;
  data: any;
  ...
  valor_id_banner_firma: any;
  post = new BannerFirma();
  constructor(
    private formBuilder: FormBuilder,
    private dataService: BannerFirmaService,
  ...
  ngOnInit(): void {
    ...
    this.route.queryParams.subscribe((params) => {
      ...
      this.valor_id_banner_firma = categoryId;
    });
  }
  ...
  onSubmit() {
    ...
    formData.append('id_banner_firma', this.valor_id_banner_firma);

    this.dataService.updateData(formData).subscribe((res) => {
      this.data = res;
      console.log(this.data);
      this.alerta();
      this.router.navigate(['/admin/banner/firma']);
    });
  }
