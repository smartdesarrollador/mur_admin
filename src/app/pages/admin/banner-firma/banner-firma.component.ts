...
@Component({
  selector: 'app-banner-firma',
  standalone: true,
  imports: [CommonModule, FormsModule, ReactiveFormsModule, HttpClientModule],
  templateUrl: './banner-firma.component.html',
  styleUrl: './banner-firma.component.css',
})
export class BannerFirmaComponent {
  listCategories: any = [];
  files_date: any;
  submitted = false;
  data: any;
  ...
  onEdit(category: BannerFirma) {
    console.log(category);
    this.dataService.selectCategory = Object.assign({}, category);
    this.router.navigate(['/admin/banner/firma/edit'], {
      queryParams: { categoryId: category.id_banner_firma },
    });
  }
